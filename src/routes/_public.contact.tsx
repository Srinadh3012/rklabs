    ...
    <div className="w-full pb-20">
      ...
      <section className="relative pt-16 md:pt-24 pb-12 overflow-hidden border-b border-white/10 bg-[#0f172a]/50">
        ...
        <div className="container relative z-10 mx-auto px-6 text-center">
          ...
          >
            Have a question or need a quote? Reach out to us and our expert technicians will assist you.
          </motion.p>
        </div>
      </section>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">Shop No 5, Sri Srinivasa Complex<br/>Opp. R.T.C Bus Stand<br/>Guntur, Andhra Pradesh 522001</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">
                        <a href="tel:+919666984949" className="hover:text-cyan-400 transition-colors">+91 96669 84949</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">
                        <a href="mailto:info@rkrepairlabs.com" className="hover:text-cyan-400 transition-colors">info@rkrepairlabs.com</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">Monday - Saturday: 10:00 AM - 8:30 PM<br/>Sunday: Closed</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#1e293b]/50 border border-white/10 rounded-3xl p-8 md:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input required placeholder="John Doe" className="bg-[#020617] border-white/10 h-12 text-white" />
                  </div>
                  
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Phone Number</label>
                    <Input required type="tel" placeholder="+91 XXXXX XXXXX" className="bg-[#020617] border-white/10 h-12 text-white" />
                  </div>
                  
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Email Address (Optional)</label>
                    <Input type="email" placeholder="john@example.com" className="bg-[#020617] border-white/10 h-12 text-white" />
                  </div>

                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Device & Issue</label>
                    <Textarea required placeholder="E.g. MacBook Pro M1 - Screen cracked" className="bg-[#020617] border-white/10 min-h-[120px] resize-y text-white" />
                  </div>

                  <Button type="submit" disabled={isSubmitting} className="w-full h-12 text-base font-bold bg-cyan-500 hover:bg-cyan-400 text-black">
                ...
                <div className="mt-8 pt-8 border-t border-white/10 text-center">
                  ...
                  <a href="https://wa.me/919666984949" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-xl font-bold hover:bg-[#20bd5a] transition-colors">
