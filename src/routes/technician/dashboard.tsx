  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-slate-400">Manage your assigned repairs and track progress.</p>
      </div>
        ...
        <div className="rounded-xl border border-white/10 bg-[#0f172a]/50 p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-sm text-slate-400">Currently Working On</div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-white/10 bg-[#0f172a]/50 p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-sm text-slate-400">Total Pending Jobs</div>
            </div>
          </div>
        </div>
      ...
      <div className="rounded-xl border border-white/10 bg-[#0f172a]/50 overflow-hidden">
        <div className="border-b border-white/10 px-6 py-4 flex justify-between items-center">
          ...
          <Link to="/technician/jobs" className="text-sm text-cyan-400 hover:underline">
            View All Jobs
          </Link>
        </div>
        ...
        {assignedJobs.length === 0 ? (
          <div className="p-12 text-center text-slate-400">
            <CheckCircle2 className="mx-auto h-12 w-12 text-slate-500/50 mb-3" />
