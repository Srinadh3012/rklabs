...
import { Phone, CheckCircle2, Laptop, Smartphone, Wrench, Microscope, ShieldCheck } from "lucide-react";
    ...
    <div className="w-full pb-20">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-white mb-4">
                Expert Hands. <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Trusted Repairs.</span>
              </h1>
            ...
            >
              <p className="text-base md:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                MacBook & iPhone specialists. Skilled professionals with deep knowledge of all major brands and models. Chip-level fixes, screens, batteries, charging, and more.
              </p>
            </motion.div>
            ...
            >
              <a href="tel:+919666984949" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white text-black px-8 py-3.5 rounded-xl font-bold hover:bg-slate-200 transition-colors">
                <Phone className="h-5 w-5" /> Call Now
              </a>
              <Link to="/track" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#1e293b] border border-white/10 text-white px-8 py-3.5 rounded-xl font-semibold hover:bg-white/5 transition-colors">
                Track Repair
              </Link>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-[#0f172a]/50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: ShieldCheck, title: "Free Diagnosis", desc: "No-obligation device checkup & estimate." },
              { icon: Laptop, title: "MacBook & iPhone", desc: "Expert in Apple repairs, with genuine quality parts." },
              { icon: Wrench, title: "Any Brand, Any Problem", desc: "From broken screens to complex motherboard repairs." },
              { icon: Microscope, title: "Advanced Tools", desc: "Chip-level lab, skilled technicians, clean workflow." },
            ].map((feature, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-b from-[#1e293b] to-[#0f172a] rounded-3xl p-8 border border-white/10 relative overflow-hidden group">
              ...
              <ul className="space-y-4 relative z-10">
                {["Chip-level repair", "Screen replacement", "DC jack repairs", "Hinges repairs", "Dead condition recovery"].map((item, i) => (
            ...
            <div className="bg-gradient-to-b from-[#1e293b] to-[#0f172a] rounded-3xl p-8 border border-white/10 relative overflow-hidden group">
              ...
              <ul className="space-y-4 relative z-10">
                {["Screen & body damages", "Slow and hanging issues", "Software updates", "Battery replacement", "Water damage repair"].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-slate-300">
                    <CheckCircle2 className="h-5 w-5 text-cyan-500 shrink-0" />
                    <span>{item}</span>
                  </li>
            ...
            <div className="bg-gradient-to-b from-[#1e293b] to-[#0f172a] rounded-3xl p-8 border border-white/10 relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-white mb-6 relative z-10">Accessories & Upgrades</h3>
              <ul className="space-y-4 relative z-10">
                {["Genuine parts", "Performance upgrades", "Storage solutions", "Chargers & cables", "Protective cases"].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-slate-300">
                    <CheckCircle2 className="h-5 w-5 text-cyan-500 shrink-0" />
                    <span>{item}</span>
                  </li>
          ...
          <div className="mt-12 text-center">
            <Link to="/services" className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 font-semibold transition-colors">
      ...
      <section className="py-16 bg-[#0f172a]/80 border-y border-white/5 overflow-hidden">
        <div className="container mx-auto px-6 mb-8">
          <p className="text-center text-sm font-semibold tracking-widest uppercase text-slate-500">Trusted by All Major Brands</p>
        </div>
