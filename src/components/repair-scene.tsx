...
export default function RepairScene({ className = "" }: { className?: string }) {
  ...
  return (
    <div ref={ref} className={className} aria-hidden data-animate={animate ? "on" : "off"}>
      ...
      <svg viewBox="0 0 1200 740" className="rk-repair-scene h-full w-full" role="img" aria-label="Mobile phone, laptop and repair kit">
        <defs>
          ...
          <filter id="rk-shadow" x="-50%" y="-50%" width="200%" height="200%">
            <feDropShadow dx="0" dy="6" stdDeviation="14" floodColor="var(--foreground)" floodOpacity="0.12" />
          </filter>
        </defs>
        ...
        <g transform="translate(60, 80) rotate(-12)">
          <g className="rk-float">
            <g filter="url(#rk-shadow)">
              <rect x="0" y="0" width="58" height="96" rx="10" fill="url(#rk-body)" stroke="var(--foreground)" strokeOpacity="0.55" strokeWidth="2.5" />
              <rect x="4" y="7" width="50" height="72" rx="5" fill="url(#rk-screen)" />
              <rect x="4" y="7" width="50" height="72" rx="5" fill="var(--neon)" fillOpacity="0.15" className="rk-pulse" />
            </g>
            ...
            <line x1="29" y1="-9" x2="29" y2="0" stroke="var(--foreground)" strokeOpacity="0.4" strokeWidth="2.5" strokeLinecap="round" />
        ...
        <g transform="translate(1060, 80) rotate(10)">
          <g className="rk-float-2">
            <g filter="url(#rk-shadow)">
              <rect x="0" y="0" width="120" height="78" rx="8" fill="url(#rk-body)" stroke="var(--foreground)" strokeOpacity="0.55" strokeWidth="2.5" />
              <rect x="7" y="7" width="106" height="55" rx="4" fill="url(#rk-screen)" />
              <rect x="7" y="7" width="106" height="55" rx="4" fill="var(--neon)" fillOpacity="0.15" className="rk-pulse" />
            </g>
            <g stroke="var(--foreground)" strokeWidth="2.5" strokeLinecap="round" opacity="0.7">
            ...
            <path d="M-16 78 h152 l-12 16 h-128 z" fill="url(#rk-tool)" stroke="var(--foreground)" strokeOpacity="0.55" strokeWidth="2.5" />
            <rect x="41" y="-10" width="38" height="9" rx="2" fill="var(--foreground)" fillOpacity="0.12" stroke="var(--foreground)" strokeOpacity="0.4" strokeWidth="1.5" />
          </g>
        </g>
